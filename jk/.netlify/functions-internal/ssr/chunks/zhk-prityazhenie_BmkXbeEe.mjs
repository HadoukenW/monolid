const id = "zhk-prityazhenie.md";
						...
						const body = "";
						const data = {title:"ЖК Притяжение",titleForLayots:"ЖК Притяжение",description:"Lorem ipsum dolor sit amet",location:"Сосновский",year:"2027",buildingType:"Панельный",heroImage:
