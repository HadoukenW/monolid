const id = "81-2-zhk-riverside.md";
						...
						new Proxy({"src":"/_astro/7V6-B3M7-8Q (1).BmYE0UQ_.webp","width":1280,"height":703,"format":"webp","fsPath":"C:/Users/hadou/OneDrive/Рабочий стол/monolid/monolid/jk/public/81 2 дом/7V6-B3M7-8Q (1).webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/hadou/OneDrive/Рабочий стол/monolid/monolid/jk/public/81 2 дом/7V6-B3M7-8Q (1).webp";
							}
