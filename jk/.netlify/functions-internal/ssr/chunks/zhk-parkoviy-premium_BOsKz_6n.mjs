const id = "zhk-parkoviy-premium.md";
						...
						const body = "";
						const data = {title:"ЖК Парковый Премиум",titleForLayots:"ЖК Парковый Премиум",description:"Lorem ipsum dolor sit amet",location:"Калининский",year:"2027",buildingType:"Монолитный",heroImage:
						new Proxy({"src":"/_astro/image-1.CypVihtA.jpg","width":1280,"height":853,"format":"jpg","fsPath":"C:/Users/hadou/OneDrive/Рабочий стол/monolid/monolid/jk/public/ЖК Парковый Премиум/image-1.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/hadou/OneDrive/Рабочий стол/monolid/monolid/jk/public/ЖК Парковый Премиум/image-1.jpg";
							}
