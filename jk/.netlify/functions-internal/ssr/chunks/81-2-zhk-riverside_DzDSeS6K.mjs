const id = "81-2-zhk-riverside.md";
						...
						const body = "";
						const data = {title:"81.2 дом ЖК Академ Риверсайд",titleForLayots:"81.2 доме ЖК Акадам Риверсайд",description:"Lorem ipsum dolor sit amet",location:"Калининский",year:"2027",buildingType:"Монолитный",heroImage:
						new Proxy({"src":"/_astro/81  1.AJexNkE-.webp","width":2286,"height":1248,"format":"webp","fsPath":"C:/Users/hadou/OneDrive/Рабочий стол/monolid/monolid/jk/public/81 дом/81  1.webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/hadou/OneDrive/Рабочий стол/monolid/monolid/jk/public/81 дом/81  1.webp";
							}
