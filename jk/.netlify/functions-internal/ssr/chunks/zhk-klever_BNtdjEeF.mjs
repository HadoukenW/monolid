const id = "zhk-klever.md";
						...
						const body = "";
						const data = {url:"zhk-klever",title:"ЖК Клевер",city:"в городе Челябинск",titleForLayots:"данной квартире в ЖК Клевер",description:"ЖК Клевер - современное жилье в самом сердце города. Элегантный дизайн, удобное расположение, разнообразная инфраструктура и природные зоны делают его идеальным выбором для комфортной и стильной жизни.",location:"Калининский",year:"2027",buildingType:"Монолитный",heroImage:
