const id = "81-2-zhk-riverside.md";
						...
						const body = "";
						const data = {url:"81-2-zhk-riverside",title:"ЖК Академ Риверсайд дом 81.2",city:"в городе Челябинск",titleForLayots:"81.2 доме ЖК Академ Риверсайд",description:"Откройте для себя комфорт и современность в ЖК Академ Риверсайд 81.2 в Челябинске. Панельные апартаменты на 20 этажах, с планировками от студий до 2-комнатных. Уникальные возможности для первых владельцев в III квартале 2025. Забронируйте ваш идеальный дом прямо сейчас и станьте частью центральной части города!",location:"Калининский",year:"2025",buildingType:"Панельный",heroImage:
