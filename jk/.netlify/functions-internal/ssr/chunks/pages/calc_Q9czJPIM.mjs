...
import 'kleur/colors';
import { $ as $$Footer, a as $$Header, b as $$BaseHead } from './404_C2CttF4i.mjs';
import 'clsx';
/* empty css                           */
/* empty css                         */
...
const SITE_DESCRIPTION = "Являемся крупной компанией, специализирующейся на продаже квартир в новостройках и вторичного жилья в Челябинске. Наша главная цель – обеспечить высокий уровень сервиса, профессионализм и индивидуальный подход к каждому клиенту.";
