...
const $$HeaderLink = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<li itemprop="name"${addAttribute(["header__li", [className]], "class:list")} data-astro-cid-eimmu3lg> <a itemprop="url"${addAttribute(href, "href")}${addAttribute([className, { active: isActive }], "class:list")}${spreadAttributes(props)} data-astro-cid-eimmu3lg> ${renderSlot($$result, $$slots["default"])} </a> ${isVtorichkaUrl && renderTemplate`<span class="vtorichka__badge" data-astro-cid-eimmu3lg>В продаже</span>`} </li> `;
